    ...
    <div class="container">
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom mt-3">
            <a href="/" class="d-flex align-items-center text-dark text-decoration-none">
                ...
                <span class="fs-4">The Aktau Times</span>
            </a>
            @guest
                <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    <a class="me-3 py-2 text-dark text-decoration-none" href="{{ route('login.route') }}">Войти</a>
                    <a class="me-3 py-2 text-dark text-decoration-none" href="{{ route('register.create') }}">Регистрация</a>
                </nav>
            @else
                <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
